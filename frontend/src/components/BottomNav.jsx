...
const navItems = [
  ...
  },
  {
    ...
    icon: (active) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="11" cy="11" r="8" fill={active ? "currentColor" : "none"} stroke="currentColor" />
  ...
  },
  {
    ...
    icon: (active) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        {active ? (
          <path d="M12 2L13 11L22 12L13 13L12 22L11 13L2 12L11 11Z" fill="currentColor" stroke="none" />
        ) : (
          <>
